"use client"; // Enables the use of client-side hooks like useState and useEffect
...
// Ad interface defining the expected shape of ad objects
interface Ad {
  _id: string;
  title: string;
  description: string;
...
// Main component for ad moderation page
export default function ModerationPage() {
  ...
  // Effect to check auth status and fetch pending ads if authorized
  useEffect(() => {
  ...
  // Fetches ads with pending status
  ...
  // Sends request to approve an ad
  ...
  // Opens modal for rejection with the selected ad ID
  ...
  // Sends request to reject an ad with a reason
  const handleReject = async () => {
    ...
    try {
      ...
      // Remove rejected ad from state and close modal
